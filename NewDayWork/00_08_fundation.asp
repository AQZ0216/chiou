...
strSQL_acr="Select * from " & tb_name_acr &" where ( wk_gp like '%資訊部%' or wk_gp like '%社企%' ) and not((hide=true) and (st_qdate < #"& date() &"# )) order by wk_gp_sq asc"
...
'將frm_main的網頁轉址到切換使用者登入前之畫面
         str_url="./00_08_fundation_page.asp?p_uid="& p_userid
...
<body>
<center>
<form name="form_login" method=post action="00_08_fundation.asp">

<font style="font-family:'標楷體';font-size:30px;font-weight:bold;letter-spacing:15px;">喬大文化基金會管理系統</font>
<hr width=300>
...
<hr color=red width=660>
	<font onclick="parent.location.href=''" style="cursor:hand;font-size:20px;font-weight:bold;letter-spacing:15px;background-color:#c3c3c3;">　基金會管理　</font>
<hr color=red width=660>
