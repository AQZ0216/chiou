...
dtDate = DateSerial(nYear, nMonth, 16)
...
strbackURL="wk_Calendar_all_prd.asp?nMonth="&nMonth&"&nYear="&nYear
...
sub mysel1
	...
	location.href="./wk_calendar_all_prd.asp?nMonth="&s_month&"&nYear="&s_Year
end sub
sub mysel2
...
<tr style="height:25px">
	<td align=center style="font-size:18px;letter-spacing:1px;" >
		<b><%=worker%>未完成工作日曆表</b>&nbsp;﹝下半月﹞ 
	<td colspan=3 align=center style="font-size:15px;cursor:hand;">
	<a href="wk_calendar_all_prd.asp" style="font-size:15px;letter-spacing:1px;font-weight:bold;color:black;">
...
<tr style="height:25px">
	...
	<img SRC='img/list.bmp' align=middle WIDTH='30' HEIGHT='20' BORDER='0' ALT='條列式日曆' style='cursor:hand;' OnClick="location.href='wk_Calendar_list_all_pr.asp?nMonth=<%=nMonth%>&nYear=<%=nYear%>'">
	&nbsp;
	顯示年份： 
	...
	<td align=center style="font-size:19px;cursor:hand;font-weight:bold;">
		<img SRC='img/pre_year.bmp' align=middle WIDTH='30' HEIGHT='20' BORDER='0' ALT='上一年' style='cursor:hand;' OnClick="location.href='wk_Calendar_all_prd.asp?nMonth=<%=pre2month%>&nYear=<%=pre2year%>'">
		<img SRC='img/next_year.bmp' align=middle WIDTH='30' HEIGHT='20' BORDER='0' ALT='下一年' style='cursor:hand;' OnClick="location.href='wk_Calendar_all_prd.asp?nMonth=<%=pre3month%>&nYear=<%=pre3year%>'">
	<td align=center style="font-size:19px;cursor:hand;font-weight:bold;">
		<font style="vertical-align:bottom;font-size:18px;letter-spacing:2px;">西元<%=cstr(nYear)%>年<%=cstr(nMonth)%>月</font>
	<td align=center style="font-size:19px;cursor:hand;font-weight:bold;">
		<img SRC='img/pre_month.bmp' align=middle WIDTH='30' HEIGHT='20' BORDER='0' ALT='上一月' style='cursor:hand;' OnClick="location.href='wk_Calendar_all_prd.asp?nMonth=<%=pre1month%>&nYear=<%=pre1year%>'">
		<img SRC='img/next_month.bmp' align=middle WIDTH='30' HEIGHT='20' BORDER='0' ALT='下一月' style='cursor:hand;' OnClick="location.href='wk_Calendar_all_prd.asp?nMonth=<%=pre4month%>&nYear=<%=pre4year%>'">
</table>
	<table border=0 bgcolor="gray" cellpadding=0 style="border-width:0px;width:700px;">
	...
	<tr bgcolor="#ffffc0" style="height:60px;">
		...
		do
			...
			if not rstObj1.EOF then
				...
				'重設資料變數 
				set rstObj1=Nothing
					'Response.Write "<tr style=""width:100%;height:150px;"">"
					'Response.Write "<td align=center style=""background-color:#e0e0e0;font-size:13px;padding:5 5 5 5;border-width:1 0 0 0;"">&nbsp;"
