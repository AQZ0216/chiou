...
<font color=red>
<%
if not(request("ermsg")="" or isnull(request("ermsg"))) then
   'str_ermsg="請確實輸入主旨、內容、工作日期、知會人員等資料！！"
   response.write  request("ermsg")&"<br>"&"請重新輸入！！"
else
end if
%>
</font>
<form name="form1" action="3_mobilejs_wk_add_ok.asp" method="post" >
<input type="hidden" name="worker1" value="<%=worker%>" >
<input type="hidden" name="wk_group" value="<%=wk_group_a(0)%>" >
<input type="hidden" name="wk_pjn" value="0" >
<input type="hidden" name="wk_order" value="<%=wk_order%>" >
<input type="hidden" name="wk_class" value="<%=wk_class_a(0)%>" >
<input type="hidden" name="undo_date1" value="<%=undo_date1%>" >
<font style="font-size:5mm;" color="red"><b><%=worker%>工作公告單</b></font>
<table border=1 cellspacing=0 cellpadding=0 style="width:600px;">
<col style="width:100px;">
<col style="">
<tr>
	<td align="right"><font color="red">執行日期</font></td>
	<td ><input type='text' name="doing_date1" id="do_date" value="<%=datecode%>" style="width:100%;"></td>
</tr>
<tr>
	<td align="right">	<font color="red">主旨</font></td>
	<td >	<input type='text' name='wk_item' id="t_item" value='' style="width:100%;"  >	</td>
</tr>
<tr>
	<td align="right">
	...
	<input type='text' name='wk_exe' id='t_exe' value='' style="width:50%;">
...
<tr>
	...
	<td ><TEXTAREA name="wk_content" id="t_content" rows="5" style="width:100%;" ><%=wk_content%></TEXTAREA></td>
</tr>
<tr>
