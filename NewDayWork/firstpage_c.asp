...
input{font-family:'標楷體';font-size:12pt;}
.ma1{
	font-family:'新細明體';
	color:red;
	font-size:12pt;
...
<TR><TD VALIGN=TOP>
	...
	<tr>
		<td align=center><font size=4><% = worker %> 你好！</font></td>
	</tr>
	<tr><td align=center>
		<!-- #Include file = "./include/toolbar_worker_first.inc" -->
	</td></tr>
	</FORM>	
	<td align=center>
		<table>
		<tr align=center>
		<td width=150><A Href='wkr_add.asp' target=_top><font size=4>工作人員修改</font></A></td>
		<td width=150><A Href='../customer/login.asp' target=_top><font size=4>客戶資料編修</font></A></td>
		<td width=150><A Href="file://Chiou-server/work_control/土地資料.xls" target="_blank"><font face="標楷體" size=4>道路用地輸入</font></a></td>
		<td width=150><A Href='../tel_message/login_msg.asp' target=_blank><font size=4>今日客戶來電</font></A></td>
		</tr>
		</table>
	</td>
	</table>
