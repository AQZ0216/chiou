...
<b>修改附件之檔案說明</b>
<a href="wk_show.asp?wk_id=<%=pwk_id%>" title="顯示工作內容">工作wk_id=<%=pwk_id%></a>
</td>
</tr>
<tr>
   ...
   <td><%=pfl_name%></td>
   <td><input type="submit" name="button1" value="確定修改" style="width:100%"></td>
</tr>
</table>
