...
<tr>
	...
	<td colspan=5>
	<input type='text' name='wk_exe' value='' style="width:50%;" readonly title="執行人員請採用右方下拉選單輸入！！！">
	...
	if document.form1.wk_exe.value="" then
		document.form1.wk_exe.value=document.form1.exemen_w.value
         ...
         if instr(1,document.form1.wk_exe.value,document.form1.exemen_w.value,1)>0 then
            ...
            if left(document.form1.wk_exe.value=",") then document.form1.wk_exe.value=right(document.form1.wk_exe.value,len(document.form1.wk_exe.value)-1)
            if right(document.form1.wk_exe.value=",") then document.form1.wk_exe.value=left(document.form1.wk_exe.value,len(document.form1.wk_exe.value)-1)
         else
