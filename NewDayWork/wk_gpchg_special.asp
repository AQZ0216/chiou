...
rstobj1.MoveFirst
'讀取資料
rstObj1.fields("wk_content")= date()&"轉為專案工作並取消完成日期("&rstObj1.fields("done_date1")&")："&chr(13)&rstObj1.fields("wk_content")
'rstObj1.fields("doing_date1")= p_doing_date1
'rstObj1.fields("wk_item")= p_wk_item
rstObj1.fields("done_date1")=null
rstObj1.fields("wk_finisher")=""
rstObj1.fields("wk_undoer")=rstObj1.fields("wk_doer")
