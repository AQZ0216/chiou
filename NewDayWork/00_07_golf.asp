...
strSQL_acr="Select * from " & tb_name_acr &" where (wk_gp like '%企劃部%' or wk_gp like '%資訊部%' or wk_gp like '%管理部%' or wk_gp like '%財務部%' or wk_gp like '%法務部%' ) and not((hide=true) and (st_qdate < #"& date() &"# )) order by wk_gp_sq asc"
...
<body>
<center>
<form name="form_login" method=post action="00_07_golf.asp">

<font style="font-family:'標楷體';font-size:30px;font-weight:bold;letter-spacing:15px;">喬大高爾夫管理系統</font>
<hr width=300>
