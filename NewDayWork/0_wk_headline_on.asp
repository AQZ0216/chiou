...
<BODY>
<center>
<form name="form1" action="0_wk_headline_on.asp" method="post">
<input type="hidden" name="wk_id" value="<%=wk_id%>">
<input type="hidden" name="worker" value="<%=worker%>">
<font style="font-size:16pt;" color="red">要將此【工作主旨】列為重大訊息，請輸入密碼！！</font><br>
<font style="font-size:12pt;" color="blue">將【主旨】列為首頁跑馬燈！！</font><br>
