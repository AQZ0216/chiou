...
<tr style="height:25px">
	<td align=center style="font-size:20px;letter-spacing:1px;" >
		<b><%=worker%>完成工作日曆表</b>
		<a href="wk_calendar_alldone_pr.asp" target="_blank" style="font-size:3.5mm;letter-spacing:1px;color:red;">[友善列印]</a>
...
<tr style="height:25px">
	...
	<img SRC='img/list.bmp' align=middle WIDTH='30' HEIGHT='20' BORDER='0' ALT='條列式日曆' style='cursor:hand;' OnClick="parent.content.location.href='wk_Calendar_list_alldone.asp?nMonth=<%=nMonth%>&nYear=<%=nYear%>'">
	&nbsp;
	顯示年份： 
	...
	<td align=center style="font-size:19px;cursor:hand;font-weight:bold;">
		<img SRC='img/pre_year.bmp' align=middle WIDTH='30' HEIGHT='20' BORDER='0' ALT='上一年' style='cursor:hand;' OnClick="parent.content.location.href='wk_Calendar_alldone.asp?nMonth=<%=pre2month%>&nYear=<%=pre2year%>'">
		<img SRC='img/next_year.bmp' align=middle WIDTH='30' HEIGHT='20' BORDER='0' ALT='下一年' style='cursor:hand;' OnClick="parent.content.location.href='wk_Calendar_alldone.asp?nMonth=<%=pre3month%>&nYear=<%=pre3year%>'">
	<td align=center style="font-size:19px;cursor:hand;font-weight:bold;">
		<font style="vertical-align:bottom;font-size:18px;letter-spacing:2px;">西元<%=cstr(nYear)%>年<%=cstr(nMonth)%>月</font>
	<td align=center style="font-size:19px;cursor:hand;font-weight:bold;">
		<img SRC='img/pre_month.bmp' align=middle WIDTH='30' HEIGHT='20' BORDER='0' ALT='上一月' style='cursor:hand;' OnClick="parent.content.location.href='wk_Calendar_alldone.asp?nMonth=<%=pre1month%>&nYear=<%=pre1year%>'">
		<img SRC='img/next_month.bmp' align=middle WIDTH='30' HEIGHT='20' BORDER='0' ALT='下一月' style='cursor:hand;' OnClick="parent.content.location.href='wk_Calendar_alldone.asp?nMonth=<%=pre4month%>&nYear=<%=pre4year%>'">
</table>
	<table border=0 bgcolor="gray" cellpadding=1 style="width:100%;border-width:0px;width:970px;">
		...
		do
			...
			if int(nYear)=int(Year(date()))and int(nMonth)=int(Month(date()))and int(Day(dtDate))=int(day(date())) then
				...
				Response.Write "<td valign=""top"" bgcolor="&bgc&" >"
					...
					Response.Write "<font style=""font-size:13px;""><a href='wk_add_date.asp?datecode="&dtDate&"'>新增"
			...
			if not rstObj1.EOF then
				...
				for i = 1 to totalput
					...
					Response.Write "<font style=""font-size:13px;"">"&i&"、<a href='wk_show.asp?wk_id="&wk_id&"'>" &rstObj1.fields("wk_item") 
