...
<td colspan=2 align='center'>
	<input class=imenu type=button name="sent" value="編輯專案" onclick="parent.location.href='pj_edit.asp?p_id=<%=p_00%>'" onmouseover="javascript:this.style.background='#FFd700';" onmouseout="javascript:this.style.background='<%=botton_color%>';" >
	<input class=imenu type=button name="del" value="刪除專案" onclick="parent.location.href='pj_del.asp?p_id=<%=p_00%>'" onmouseover="javascript:this.style.background='#FFd700';" onmouseout="javascript:this.style.background='<%=botton_color%>';">
	<input class=imenu type=button name="list" value="專案列表" onclick="parent.location.href='pj_list.asp'" onmouseover="javascript:this.style.background='#FFd700';" onmouseout="javascript:this.style.background='<%=botton_color%>';">
