...
<TABLE BORDER=1 cellspacing=0 cellpadding=0 width=783>
			<tr style="height:35pt;">
				<td align=center style="background-color:#99FFFF;"><font style="font-size:20pt;letter-spacing:2mm;">歡迎進入資訊部管理系統!!</font></td>
			</tr>
			...
			<tr>
				...
				<table border=1 style="width:100%">
					...
					<tr align=center style="height:25pt;" >
						<td class=tde ><A class=tda Href='' target='_blank' >電話紀錄</A></td>
						<td class=tde ><A class=tda Href='' target='_blank' >銷售案件</A></td>
						<td class=tde ><A class=tda Href='' target=_blank>土地開發</A></td>
					...
					<tr align=center style="height:25pt;" >
						...
						<td class=tde ><A class=tda Href='' target=_blank>休假資料</A></td>
						<td class=tde ><A class=tda Href='' target='_blank' >&nbsp;</A></td>
					</tr>
					<tr align=center style="height:25pt;" >
						<td class=tde >
							<font class="flink" onclick="window.open('')" >新謄本系統</font>
							</td>
						<td class=tde >
							<font class="flink" onclick="window.open('')" >【新士科】</font>
							</td>
						<td class=tde ><A class=tda Href='' target='_blank' >關貿謄本</A></td>
						<td class=tde ><A class=tda Href='' target='_blank' >土地謄本</A></td>
					</tr>
					<tr align=center style="height:25pt;" >
						<td class=tde ><A class=tda Href='' target='_blank' >士科謄本</A></td>
						<td class=tde ><A class=tda Href='' target=_blank>三合段謄本</A></td>
						<td class=tde ><A class=tda Href='' target='_blank' >蘆北謄本</A></td>
						<td class=tde ><A class=tda Href='' target='_blank' >考勤資料</A></td>
					</tr>
					<tr align=center style="height:25pt;" >
						<td class=tde ><A class=tda Href='' target='_blank' >實價登錄-喬大</A></td>
						<td class=tde ><A class=tda Href='' target='_blank' >新實價登錄</A></td>
						<td class=tde ><A class=tda Href='' target='_blank' >關渡謄本</A></td>
						<td class=tde ><A class=tda Href='' target='_blank' >關渡客戶</A></td>
					</tr>
					<tr align=center style="height:25pt;" >
						<td class=tde ><A class=tda Href='' target='_blank' style="color:red;background-color:#e1e1e1;" >【業績日期】</A></td>
						<td class=tde ><A class=tda Href='' target='_blank' >新土地謄本</A></td>
						<td class=tde ><A class=tda Href='' target='_blank' >塭仔圳地號</A></td>
						<td class=tde ><A class=tda Href='' target='_blank' >關貿謄本資料</A></td>
					</tr>
					<tr align=center style="height:25pt;" >
						<td class=tde ><A class=tda Href='../daywork/firstpage_elink.asp' target='_blank' >修改網頁連結</A></td>
						<td class=tde ><A class=tda Href='' target='_blank'>客戶資料</A></td>
