...
<div class="vt-container w3-brown" >
<!--內容-->
      <div class="vt-container w3-row w3-center w3-pale-blue" style="width:100%;height:550px;overflow: hidden;">
		 <iframe id="ifrm_content" name="ifrm_content" src="zec-wk_Calendar_all.asp?worker=<%=worker%>" style="border:0px;width:100%;height:100%;"></iframe>	
      </div>
</div>
<div class="vt-container footer w3-brown w3-center"  style="height:40px;overflow: hidden;margin:0px;padding:0px;">
