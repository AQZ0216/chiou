...
<TABLE BORDER=1 cellspacing=0 cellpadding=0 width=783>
			<tr style="height:35pt;">
				<td align=center style="background-color:#FFB3FF;"><font style="font-size:20pt;letter-spacing:2mm;">歡迎進入基金會管理系統!!</font></td>
			</tr>
			...
			<tr>
				...
				<table border=1 style="width:100%">
					...
					<tr align=center style="height:25pt;" >
						<td class=tde ><A class=tda Href='../ctelmsg/ct_login.asp' target='_blank' >電話紀錄</A></td>
						<td class=tde ><A class=tda Href='http://192.168.0.10/chiou/cbooks/bs_main.asp' target='_blank' >贈書管理</A></td>
						<td class=tde ><A class=tda Href='' target='_blank' >&nbsp;</A></td>
						<td class=tde ><A class=tda Href='' target='_blank' >&nbsp;</A></td>
					</tr>
					<tr align=center style="height:25pt;" >
						<td class=tde ><A class=tda Href='../transcript/ts_main.asp' target='_blank' >關渡謄本</A></td>
						<td class=tde ><A class=tda Href='../kcrbase/kcrbase_main.asp' target='_blank' >關渡客戶</A></td>
						<td class=tde ><A class=tda Href='' target='_blank' >&nbsp;</A></td>
						<td class=tde ><A class=tda Href='' target='_blank' >&nbsp;</A></td>
					</tr>
					<tr align=center style="height:25pt;" >
					...
					<tr align=center style="height:25pt;" >
						<td class=tde ><A class=tda Href='' target='_blank' >&nbsp;</A></td>
						<td class=tde ><A class=tda Href='../customer/login.asp' target=_top>客戶資料</A></td>
						<td class=tde ><A class=tda Href='../dataman/基本範本.asp' target='_blank' >基本範本檔</A></td>
						<td class=tde ><A class=tda Href='../daywork/firstpage.asp' target='_blank' >回首頁</A></td>
					</tr>
				</table>
				</td>
			</tr>
