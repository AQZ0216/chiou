...
strSQL_acr="Select * from " & tb_name_acr &" where (wk_gp like '%企劃部%' or wk_gp like '%資訊部%' or wk_gp like '%管理部%' ) and not((hide=true) and (st_qdate < #"& date() &"# )) order by wk_sgp asc, wk_gp_sq, wkr_id asc"
...
<font style="font-family:'標楷體';font-size:30px;font-weight:bold;letter-spacing:15px;">喬大管理部管理系統</font>
<hr width=300>
